...
\\ \cline{2-2}
& $f(n) = \frac{(n^{4}-6n^{3}+23n^{2}-18{n}+24)}{24}$.
\\ \hline
...
\\ \cline{2-2}
&Para todo $n>1$ cuya descomposición en factores primos es $n=p_{1}^{a_{1}}p_{2}^{a_{2}}...p_{k}^{a_{k}}$ se tiene que:

$f(n) = \frac{p_{1}^{a_{1} + 1} - 1}{p_{1} - 1} * \frac{p_{2}^{a_{2} + 1} - 1}{p_{2} - 1} * ... * \frac{p_{k}^{a_{k} + 1} - 1}{p_{k} - 1}$ 
\\ \hline
\end{longtable}
\end{center}
