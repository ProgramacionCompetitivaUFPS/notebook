// Cambiar valores a, b, c por límites correspondientes
static int a=20, b=20, c=20;
static long acum[][][] = new long [a][b][c];
static long INF = -10000000000007L;

static long max_range_3D(){
    for(int x=0; x<a; x++){
        for(int y = 0; y<b; y++){
            for(int z = 0; z<c; z++){
                ...
                for(int h = x; h<a; h++){
                    for(int k = y; k<b; k++){
                        for(int l = z; l<c; l++){
                            ...
                            max_value = Math.max(max_value, aux);
                        }
                    }
                }
            }
